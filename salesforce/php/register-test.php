...
//        $id = $records[0]->{'Id'};
        $id = $records[0]->Id;
        print $id;
        //$deleteResult = $mySforceConnection->delete(array($id));
...
//    session_write_close();
//
//    header( 'Location: http://staging.bethel.edu/salesforce/salesforce-old/test-login' ) ;
//
////    header( 'Location: http://staging.bethel.edu/salesforce/salesforce-old/test-login?email="'. $email .'"&first="' . $first . '"&last="' . $last . '"' ) ;
//}
//
//
//
