 ...
 *
 * Load this file with `defer` and do not load calendar_v4.js on the same page.
 * The calendar_rest_v5 endpoint and Cascade-rendered filter markup
...
(function (globalObject, factory) {
    ...
    if (globalObject && globalObject.document) {
        globalObject.BethelCalendarV5 = api;
    ...
    var CONFIG = Object.freeze({
        endpoint: '/code/events/php/calendar_rest_v5',
        filterStorageKey: 'bethel.calendar.filters.v5',
        filterStorageVersion: 1,
        viewStorageKey: 'bethel.calendar.view.v5',
    ...
    function boot(documentObject, windowObject) {
        function initialize() {
            ...
            if (!calendarMode || !calendarMain || calendarMode.dataset.calendarV5Initialized === 'true') {
                return null;
            }

            calendarMode.dataset.calendarV5Initialized = 'true';
